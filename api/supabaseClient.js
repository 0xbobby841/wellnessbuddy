...
function getSupabase() {
  ...
  if (!SUPABASE_URL || !SUPABASE_SERVER_KEY) {
    ...
    // and return a clear error from the route handlers.
    // eslint-disable-next-line no-console
    console.error(
      'Supabase environment variables are missing. Please set SUPABASE_URL and SUPABASE_SECRET_KEY (or another valid server key env).',
    );
    return null;
  }
